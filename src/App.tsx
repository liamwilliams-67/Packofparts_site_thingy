      ...
      <ScrollExpandMedia
        ...
        heroReappearContent={() => (
          <div className="container-custom text-center px-4">
            ...
            {/* Eastlake Robotics Club - Reappears from right */}
            <h1 
              className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-orbitron font-bold text-white mb-4"
              style={{ 
            ...
            {/* Pack of Parts - Reappears from left */}
            <h2 
              className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-orbitron font-bold text-gradient mb-6"
              style={{ 
                animation: 'slideInFromLeft 0.6s cubic-bezier(0.16, 1, 0.3, 1) forwards',
                animationDelay: '0.2s',
                opacity: 0,
            ...
            {/* FRC Team 1294 | Sammamish, Washington - Reappears from left */}
            <p 
              className="text-white/80 text-base md:text-lg lg:text-xl max-w-2xl mx-auto mb-10"
              style={{ 
                animation: 'slideInFromLeft 0.6s cubic-bezier(0.16, 1, 0.3, 1) forwards',
                animationDelay: '0.3s',
                opacity: 0,
            ...
            {/* Join The Club button - Reappears from right */}
            <div 
              style={{ 
                animation: 'slideInFromRight 0.6s cubic-bezier(0.16, 1, 0.3, 1) forwards',
                animationDelay: '0.4s',
